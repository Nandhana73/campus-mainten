                      ...
                      <td style={{ padding: "12px" }}>
                        {editingAmountId === comp._id ? (
                          <div>
                            ...
                            />
                            <button onClick={() => handleAmountChange(comp._id)} style={{ marginLeft: "5px", padding: "5px 10px", background: "#28a745", color: "white", border: "none", borderRadius: "4px" }}>Save</button>
                          </div>
                        ) : (
                          `₹${(comp.estimatedAmount || 0).toLocaleString('en-IN')}`
                        )}
                        {comp.estimatedAmount === 0 && <button onClick={() => setEditingAmountId(comp._id)} style={{ marginLeft: "5px", padding: "3px 8px", background: "#ffc107", color: "#000", border: "none", borderRadius: "4px", fontSize: "12px" }}>Set</button>}
                      </td>
                      <td style={{ padding: "12px" }}>
